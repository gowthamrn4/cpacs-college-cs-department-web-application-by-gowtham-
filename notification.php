...
$select=mysql_query("select * from reply where showl=0 and username='".$userid."'");
   ...
   for($i=0;$i<$view;$i++)
   ?>
   <li class="active"><a style="color:#666666" href="notification.php"><span data-toggle="tooltip" title="3 New Messages" style="background-color:#0099FF" class="badge bg-green"><?php echo $view;?> </span>Older Message</a></li>
...
<table width="571" height="100" border="2" cellpadding="0" cellspacing="0">
  <tr>
    <td width="54" height="45" align="center">No</td>
        <td width="100" height="70" align="center">Time</td>
...
$select=mysql_query("select * from reply where showl=0 and username='".$userid."'");
   ...
   for($i=0;$i<$view;$i++)
   ?>
<div style="left:30.7%; top:80.2%; "> 
<div class="col-lg-3">
	     <div class="alert alert-success" ><a href="#" class="close" data-dismiss="alert" aria-label="close">x</a> <p>You Have Older <span data-toggle="tooltip" title="3 New Messages" style="background-color:#0099FF" class="badge bg-green"> <?php echo $view;?>  </span> Message</p></div>
</div></div>
    <?php
	}
