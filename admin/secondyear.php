...
$insert=mysql_query("insert into  student1(idno,rollno,regno,name,class,image,email,sex,phone,fathername,mothername,religion,address)values('$idno','$rollno','$regno','$name','$class','$second','$email','$sex','$phone','$fathername','$mothername','$religion','$address')");
}
if($insert)
{
...
<table width="77%">
 ...
 <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>?del=<?php echo mysql_result($select,$i,"rollno");?>">delete</a>&nbsp;|&nbsp;<a href="view2.php?edit=<?php echo mysql_result($select,$i,"rollno");?>">edit</a>  
