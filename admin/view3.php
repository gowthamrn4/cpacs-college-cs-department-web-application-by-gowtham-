...
if($_GET['del'])
{
$delete=mysql_query("delete from studentthi where rollno='".$_GET['del']."'");
if($delete>0)
{
...
$view=mysql_num_rows($select);
 ...
 ?>
  <tr class="success">
    ...
    <td><a href="<?php $_SERVER['DOCUMENT_ROOT'];?>?del=<?php echo mysql_result($select,$i,"rollno");?>">delete</a>&nbsp;|&nbsp;<a href="s3update.php?edit=<?php echo mysql_result($select,$i,"rollno");?>">edit</a></td>
  </tr>
  </tr></center>
  <?PHP
  }
