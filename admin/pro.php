 ...
 <center>
   ...
   <li><a href="leaveletter.php">Leave Letter</a></li>
    <li><a href="rank.php">Rank</a></li>
        <li class="active"><a href="pro.php">Professor</a></li>
...
<ul class="nav nav-tabs">
   <li class="active"><a href="pro.php">ADD</a></li>

   <li  class="active"><a style="color:#666666" href="#">View </a></li>   
...
<caption>ADD Professors</caption>

  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
      <input type="text" name="name" id="textfield" placeholder="Name" required  class="form-control"/>
         <input type="text" name="email" id="textfield"  placeholder="Email ID" required  class="form-control"/>
         <input type="text" name="phone" id="textfield"  placeholder="Phone No" required  class="form-control"/>
...
<option value="Age:"> Age </option>
	...
	<script type="text/javascript">
		...
		for(i=20;i<=70;i++)
		{
         ...
         <input type="text" name="bdate" id="textfield"  placeholder="1995/02/12" required  class="form-control"/>
<input type="text" name="level" id="textfield"  placeholder="Msc,M.phil" required  class="form-control"/>


  <textarea name="address" id="textarea" cols="45" rows="3"  placeholder="Address"></textarea>
...
$insert=mysql_query("insert into professor(no,name,email,phone,age,bdate,level,address,image,class)values('$no','$name','$email','$phone','$age','$bdate','$level','$address','$second','$class')");
}
if($insert)
{
echo "<script>
