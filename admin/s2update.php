<?php
include("db.php");
$select=mysql_query("select * from student1 where rollno='".$_GET['edit']."'");
...
$insert=mysql_query("update student1 set  idno='$idno',rollno='$rollno',regno='$regno',name='$name',class='$class',image='$second',email='$email',sex='$sex',phone='$phone',fathername='$fathername',mothername='$mothername',religion='$religion',address='$address' where rollno='".$_GET['edit']."'");
}
if($insert)
{
