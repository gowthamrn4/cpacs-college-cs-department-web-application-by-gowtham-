...
$insert=mysql_query("insert into  student(idno,rollno,regno,name,class,image,email,sex,phone,fathername,mothername,religion,address)values('$idno','$rollno','$regno','$name','$class','$second','$email','$sex','$phone','$fathername','$mothername','$religion','$address')");
}
if($insert)
{
...
<h3>1st Year Students Details</h3></div>
<div class="services bg-primary"></div>
 ...
 <center>
   ...
   <li class="active"><a href="studetails.php">Student Details</a></li>
...
<table width="77%">
 ...
 <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>?del=<?php echo mysql_result($select,$i,"rollno");?>">delete</a>&nbsp;|&nbsp;<a href="view1.php?edit=<?php echo mysql_result($select,$i,"rollno");?>">edit</a>  
