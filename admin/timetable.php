...
if($button)
{
$insert=mysql_query("insert into timetable(time1,time2,time3,time4,time5,twotime1,twotime2,twotime3,twotime4,twotime5,thrtime1,thrtime2,thrtime3,thrtime4,thrtime5,fortime1,fortime2,fortime3,fortime4,fortime5,fivtime1,fivtime2,fivtime3,fivtime4,fivtime5,sixtime1,sixtime2,sixtime3,sixtime4,sixtime5,year)values('$time1','$time2','$time3','$time4','$time5','$twotime1','$twotime2','$twotime3','$twotime4','$twotime5','$thrtime1','$thrtime2','$thrtime3','$thrtime4','$thrtime5','$fortime1','$fortime2','$fortime3','$fortime4','$fortime5','$fivtime1','$fivtime2','$fivtime3','$fivtime4','$fivtime5','$sixtime1','$sixtime2','$sixtime3','$sixtime4','$sixtime5','$year' )");
}
if($insert)
{
...
<a href="update1.php?edit=<?php echo mysql_result($select,$i,"year");?>">edit</a>

<h><center><font size="+2">1st Year</font></center></h>
<body>
<a id="menu-toggle" href="#" class="btn btn-dark btn-lg toggle"><i class="fa fa-bars"></i></a>
    <nav id="sidebar-wrapper">
        ...
        <li class="sidebar-brand">
         <li class="sidebar-brand"><a href="timetable2.php">2nd Year Time Table</a>
         </li>  <li class="sidebar-brand">
         <li class="sidebar-brand"><a href="timetable3.php">3rd Year Time Table</a></ul>
        <div style="position:absolute; top:10.2%; font-size:50px"> 
          <font size="+3"><a href="../logout.php">Logout</a></h> </font></font>
          </li>
    </nav>
<a href="update1.php">Edit</a>
...
<table width="100%" height="313" border="3">
  ...
  <tr>
   ...
   <td>
      <input type="text" name="year" id="6day5hr" />
    </td>
