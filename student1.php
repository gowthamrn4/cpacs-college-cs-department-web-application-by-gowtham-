...
<div class="nn"><h3>First Year Student Details</h3></div></div>
      ...
      <ul class="nav navbar-nav" >
         ...
         <li class="dropdown">
            ...
            <ul class="dropdown-menu">
               <li class="active"><a href="student1.php">1st Year</a></li>
...
<table class="table table-striped">
  ...
  <tr class="success">
    <td class="warning">
	 <div class="mm">
	<?php echo mysql_result($select,$i,"idno");?></div></td>
    <td>
    <div class="imgph">
    <img src="admin/<?php echo mysql_result($select,$i,"image");?>" height="100" width="100"/></div>
    </td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"name");?></div></td>
    <td >  <div class="mm"><?php echo mysql_result($select,$i,"rollno");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"regno");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"class");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"email");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"sex");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"phone");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"fathername");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"mothername");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"religion");?></div></td>
    <td > <div class="mm"><?php echo mysql_result($select,$i,"address");?></div></td>
    <td class="warning"> <div class="mm"><?php echo mysql_result($select,$i,"idno");?></div></td>
  </tr> <?php
  }
  ?>
</table></div></div>
